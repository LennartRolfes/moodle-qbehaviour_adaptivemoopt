...
$string['waitingforgradingsummary'] = 'The submission has already been submitted, but the grading process is not finished yet. Wait for the grading process to finish.';
